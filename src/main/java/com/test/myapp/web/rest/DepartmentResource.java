...
import com.test.myapp.domain.Department;
import com.test.myapp.repository.DepartmentRepository;
import com.test.myapp.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.test.myapp.domain.Department}.
 */
@RestController
@RequestMapping("/api")
