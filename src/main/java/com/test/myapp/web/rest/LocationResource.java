...
import com.test.myapp.repository.LocationRepository;
import com.test.myapp.service.LocationService;
...
/**
 * REST controller for managing {@link com.test.myapp.domain.Location}.
 */
@RestController
@RequestMapping("/api")
